        ...
        <div>
            ...
            <motion.div
                ...
                <div className="card-body">
                    ...
                    <form className="fieldset" onSubmit={submitHandler}>
                        <legend className="fieldset-legend">Select The Service Status</legend>
                        <select defaultValue= {serviceStatus} className="select" name = "status">
                        ...
                        <button className="btn btn-accent w-[200px] rounded-3xl">Update</button>
                    </form>
                </div>
            </motion.div>
        </div>
